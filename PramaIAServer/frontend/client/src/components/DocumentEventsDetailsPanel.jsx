...
const DocumentEventsDetailsPanel = ({
  pdfEvents,
  fetchPdfEvents,
  loadClients
}) => {
  return (
    <div className="bg-white p-6 rounded-lg shadow border mb-6">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-semibold">📊 Statistiche e Analisi Eventi Documenti</h3>
      ...
      <div>
        {!pdfEvents ? (
          <p>Caricamento eventi documenti...</p>
        ) : pdfEvents.error ? (
          ...
          <div>
            <div className="mb-4 p-3 bg-purple-50 rounded">
              <p className="font-semibold">Totale eventi documenti: {pdfEvents.total}</p>
            ...
            {pdfEvents.events && pdfEvents.events.length > 0 ? (
              ...
              <p className="text-gray-500">Nessun evento documento trovato</p>
            )}
          </div>
        )}
      </div>
...
export default DocumentEventsDetailsPanel;
