...
class Workflow(Base):
    ...
    is_active = Column(Boolean, default=True)  # Se il workflow ├¿ attivo
    is_public = Column(Boolean, default=False)  # Se ├¿ pubblico o privato
    ...
    priority = Column(Integer, default=0)  # Priorit├á per ordinamento (0=normale, 1=alta, -1=bassa)
...
class WorkflowNode(Base):
    ...
    resizable = Column(Boolean, default=True)  # Se il nodo pu├▓ essere ridimensionato
